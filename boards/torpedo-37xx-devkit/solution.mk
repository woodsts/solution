...
#BOARD_KERNEL_DT_OTHER ?= logicpd-torpedo-37xx-devkit-solution
...
define $(ELDS_BOARD)-bootloader-defconfig
	...
	$(MAKE) -C $(BOARD_BOOTLOADER_SCM) O=$(BOARD_BOOTLOADER_BUILD) $(ELDS_CROSS_PARAMS) omap3_logic_defconfig
endef
