...
BOARD_KERNEL_DT ?= omap3-overo-tobi
#BOARD_KERNEL_DT_OTHER ?= omap3-overo-tobi-solution
...
define $(ELDS_BOARD)-bootloader-defconfig
	...
	$(MAKE) -C $(BOARD_BOOTLOADER_SCM) O=$(BOARD_BOOTLOADER_BUILD) $(ELDS_CROSS_PARAMS) omap3_overo_defconfig
endef
